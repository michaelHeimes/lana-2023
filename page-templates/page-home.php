					...
					<section id="next" class="entry-content" itemprop="text">
						...
						<div class="section s1">
							<div class="grid-container">
								...
								<div class="s1-first grid-x grid-padding-x">
									...
									<div class="cell small-12 medium-4 tablet-3 xlarge-2">
											...
											<div class="grid-x grid-padding-x">
												...
												?>
													<div class="cell small-12 tablet-4">
														<div class="inner br-12 has-object-fit h-100">
															<?php if( $link ): 
															$link_url = $link['url'];
															$link_target = $link['target'] ? $link['target'] : '_self';
															?>
																<a class="cta-link has-bg has-arrow-link d-block make-square color-white h-100" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
															<?php endif;?>
																<?php if( !empty( $image ) ) {
																	$imgID = $image['ID'];
								...
								<div class="facts-figures-wrap grid-x grid-padding-x">
									<div class="cell small-12">
										<div class="inner has-bg inner has-bg grid-x align-middle align-center">
											...
											<div class="bg show-for-tablet" style="background-image: url(<?php echo esc_url($fields['s1_map_background_image']['url']); ?>);"></div>
											<?php endif;?>
											...
											<div class="cell small-12 tablet-10 xlarge-9 ff-wrap white-bg br-12 relative">
												<div class="grid-x grid-padding-x">
													...
													<div class="single-ff cell small-12 medium-6 tablet-3 text-center relative">
														...
														<?php endif;?>
														<hr class="yellow hide-for-medium">
														<div class="border yellow-bg show-for-medium"></div>
													</div>
													<?php endforeach;?>
												</div>
											</div>
											<?php endif;?>
											<?php if( !empty( $fields['s1_map_background_image'] ) ) {
												$imgID = $fields['s1_map_background_image']['ID'];
												$img_alt = trim( strip_tags( get_post_meta( $imgID, '_wp_attachment_image_alt', true ) ) );
												$img = wp_get_attachment_image( $imgID, 'full', false, [ "class" => "map-img hide-for-tablet", "alt"=>$img_alt] );
								...
								<div class="clients white-bg grid-pattern granite br-12">
									<div class="section-top grid-x grid-padding-x align-middle">
										...
										<div class="cell small-12 medium-auto">
											<h2 class="h4"><?php echo $fields['s1_clients_heading'];?></h2>
										</div>
										<?php endif;?>
							...
							<div class="white-bg module-padding">
								<div class="grid-container">
									<div class="grid-x grid-padding-x">
										...
										<div class="cell small-12 medium-8 tablet-9 xlarge-10">
						...
						<div class="section s3 white-bg module-padding lana-module">
							<div class="grid-container">
								...
								<div class="first-section grid-x grid-padding-x">
